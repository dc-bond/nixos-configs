  ...
  services = {
    ...
    ${app} = {
      ...
      extraConfig = ''
        ...
        transport_email_auth_username = ${configVars.users.chris.email}
        transport_email_auth_password = $GRAYLOG_USER_EMAIL_PASSWORD
        transport_email_from_email = ${configVars.users.chris.email}
