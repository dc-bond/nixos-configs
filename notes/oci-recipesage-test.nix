...

{
  ...
  virtualisation.oci-containers.containers = {
    ...
    "${app}-${app3}" = {
      ...
      environmentFiles = [ config.sops.templates."${app}-${app3}-env".path ];
    ...
    "${app}-${app6}" = {
      ...
      environmentFiles = [ config.sops.templates."${app}-${app6}-env".path ];
      extraOptions = [
        "--network=${app}"
    ...
    services = { 
      ...
      "docker-${app}-${app3}" = {
        ...
        after = [
          ...
          "docker-${app}-${app5}.service"
          "docker-${app}-${app6}.service"
          "docker-${app}-${app7}.service"
        ];
        requires = [
          "docker-network-${app}.service"
          "docker-volume-${app}-${app3}.service"
