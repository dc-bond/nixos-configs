...

{
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /persist/home/danielle 0700 danielle users -" # tmpfiles ensures directory exists before impermanence tooling bind-mounts /persist/home/{user}/.config/age directory
