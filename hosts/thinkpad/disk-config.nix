...

{
  ...
  disko.devices = {
    disk = {
      main = {
        type = "disk";
        device = "/dev/disk/by-id/nvme-WDC_PC_SN730_SDBQNTY-256G-1001_194356801585"; # 256GB NVMe SSD
        content = {
          type = "gpt";
          partitions = {
            ESP = {
  ...
  services = {
    ...
    btrfs.autoScrub = {
      ...
      fileSystems = [ "/dev/disk/by-id/nvme-WDC_PC_SN730_SDBQNTY-256G-1001_194356801585-part2" ];
    };
