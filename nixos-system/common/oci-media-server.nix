  ...
  virtualisation.oci-containers.containers = {
    ...
    "${app1}" = {
      ...
      labels = {
        ...
        "traefik.http.routers.${app2}.middlewares" = "private-whitelist@file,secure-headers@file";
        ...
        "traefik.http.routers.${app3}.middlewares" = "private-whitelist@file,secure-headers@file";
        ...
        "traefik.http.routers.${app4}.middlewares" = "private-whitelist@file,secure-headers@file";
        ...
        "traefik.http.routers.${app5}.middlewares" = "private-whitelist@file,secure-headers@file";
        ...
        "traefik.http.routers.${app6}.middlewares" = "private-whitelist@file,secure-headers@file";
        ...
        "traefik.http.routers.${app7}.middlewares" = "private-whitelist@file,secure-headers@file";
