...

{
      ...
      settings = {
        ...
        authentication_backend = {
          ...
          ldap = {
            ...
            base_dn = "dc=${configVars.domain2Short},dc=com";
            user = "uid=admin,ou=people,dc=${configVars.domain2Short},dc=com"; # admin username, password in env variable below
            #attribues = {
            #  username = "uid";
            #  group_name = "cn";
  ...
  services.redis.servers."${app}-${configVars.domain2Short}" = {
    enable = true;
