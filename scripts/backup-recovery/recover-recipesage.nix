...
let
  ...
  recoverRecipesageScript = pkgs.writeShellScriptBin "recoverRecipesage" ''
   ...
   ssh $HOST 'sudo rm -rf /var/lib/docker/volumes/recipesage-api'
   ssh $HOST 'sudo rm -rf /var/lib/docker/volumes/recipesage-postgres'
   ...
   ssh $HOST 'sudo chown -R root:root /var/lib/docker/volumes/recipesage-api'
   ssh $HOST 'sudo chown -R root:root /var/lib/docker/volumes/recipesage-postgres'
