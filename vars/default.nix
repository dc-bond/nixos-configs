  ...
  hosts = {
    ...
    thinkpad = {
      ...
      networking = {
        ...
        sshPublicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICWVv6hWg/TSIpOLHAXArr1zt3tuaDtkv32+D4kt9Pgt";
        useResolved = true;
    ...
    juniper = {
      ...
      networking = {
        sshPort = 28764;
        sshPublicKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJbtPOSQMSqkKR/P+pQ9qH7ja6nPOZHZQjSe03kPs47h root@juniper";
        useResolved = false; # runs pihole
        ethernetInterface = "enp1s0";
        wifiInterface = null;
        dockInterface = null;
